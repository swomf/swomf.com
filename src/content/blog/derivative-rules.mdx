...
would look like (source: <a href="https://piped.video/watch?v=YG15m2VwSjA&t=253" target="_blank">3b1b</a>).
...
<details>
  ...
  <div class="grid grid-cols-3 gap-4">
    ...
    <div class="text-xs sm:text-sm">
      ...
      Of course, because $$cos\theta$$ is decreasing in this area of the unit circle,
      $$d(cos\theta)$$ and thus
      $$\frac{d}{d\theta}cos\theta$$ are technically
      negative.
    </div>
...
<div class="grid grid-cols-2 gap-4 text-xs sm:text-sm">
  ...
  <div>
    ...
    then we find our missing side $$\sqrt{1-x^2}$$ using Pythagoras. After that, substitute:
  ...
  <div>
    ...
    Recall that $tan'\theta=(\sec\theta)^2.$

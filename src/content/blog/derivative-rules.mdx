...
would look like.<sup>[3b1b](https://youtube.com/watch?v=YG15m2VwSjA&t=253)</sup>
...
The chain rule (discussed later) generalizes<sup>[Math SE](https://math.stackexchange.com/a/70988)</sup> the power
...
which means the same thing.<sup>[3b1b](https://youtube.com/watch?v=YG15m2VwSjA?t=521)</sup>
...
<details>
  ...
  <div class="grid grid-cols-3 gap-4">
    ...
    <div class="text-xs sm:text-sm">
      This unit circle diagram<sup>([UNSW, 2009](https://www.animations.physics.unsw.edu.au/jw/calculus.htm#Trigonometric))</sup>
  ...
  <div class="text-xs sm:text-sm overflow-x-auto p-1 sm:overflow-hidden border-2 border-[var(--white)] rounded-lg">
    ...
    [algebra](https://www.mathsisfun.com/calculus/derivatives-trig-proof.html). However, it takes two lemmas (baby proofs)
